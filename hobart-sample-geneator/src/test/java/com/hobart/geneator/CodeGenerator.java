...
public class CodeGenerator {
    ...
    //JDBC配置，请修改为你项目的实际配置
//    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/fdd_org_test?serverTimezone=UTC";
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=utf8";
    private static final String JDBC_USERNAME = "root"; 
    private static final String JDBC_PASSWORD = "123456"; 
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";

    private static final String PROJECT_PATH = System.getProperty("user.dir").concat("/hobart-sample-geneator");//项目在硬盘上的基础路径
    private static final String PROJECT_PATH2 = System.getProperty("user.dir").concat("/hobart-sample-geneator");//模板文件在硬盘上的基础路径
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH2 + "/src/test/resources/generator/template";//模板位置
    ...
    private static final String AUTHOR = "hubo";//@author

    private static final String DATE = new SimpleDateFormat("yyyy-MM-dd").format(new Date());//@date

    public static void main(String[] args) {
//          genCode("t_hobart_employee");
...
//        convertTableNameToModel("t_hobart_employee");
     ...
     * @return 实体类名
     */
    private static String convertTableNameToModel(String tableName) {
        StringBuffer sb = new StringBuffer();
        for (String str : tableName.split("_")) {
            if (str != null && !"t".equalsIgnoreCase(str)) {
     ...
     * 如输入表名称 "t_user_detail" 将生成 UserDetail、UserDetailMapper、UserDetailService ...
     * @param tableNames 数据表名称...
     */
    public static void genCode(String... tableNames) {
        for (String tableName : tableNames) {
            genCodeByCustomModelName(tableName, convertTableNameToModel(tableName));
