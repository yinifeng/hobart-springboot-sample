...
import com.hobart.sample.core.utils.ReflectionUtils;
...
public abstract class BaseService<M extends MyMapper<T>, T> implements Service<T>{
    ...
    public BaseService() {
        ...
        modelClass = ReflectionUtils.getSuperClassGenricType(this.getClass(), 1);
    }
...
////            result += count;
////        }
        return this.mapper.deleteByIdList(list);
    }
